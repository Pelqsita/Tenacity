    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (TextButton button : textButtons) {
            ...
            switch (button.text) {
                case "Scripting":
                    button.clickAction = () -> {
                        IOUtils.openLink("https://tenacity-docs.cheatin.gg/");
                    };
                    break;
                case "Discord":
                    button.clickAction = () -> {
                        IOUtils.openLink("https://c0f.lol");
                    };
                    break;
            }
        ...
        tenacityFont18.drawCenteredString("forked by ImLegiitXD.", width / 2f, height / 2f - 68, Color.WHITE.getRGB());
