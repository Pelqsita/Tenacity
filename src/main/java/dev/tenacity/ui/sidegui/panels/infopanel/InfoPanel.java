...
public class InfoPanel extends Panel {
    ...
    public InfoPanel() {
        ...
        configInfo.faqButtons.addAll(Arrays.asList(
                new InfoButton("What client is this?",
                        "This client was coded by cedo and others, forked by ImLegiitXD. " +
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        tenacityFont18.drawString("forked by ImLegiitXD.", getX() + 8, getY() + 30, ColorUtil.applyOpacity(getTextColor(), .3f));
